...
export function LoginIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
...
export function VirusIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 11c0-1.1-.9-2-2-2s-2 .9-2 2 .9 2 2 2m0 0c1.1 0 2 .9 2 2s-.9 2-2 2m0-4c-1.1 0-2 .9-2 2s.9 2 2 2m7-2c0-1.1-.9-2-2-2s-2 .9-2 2 .9 2 2 2m0 0c1.1 0 2 .9 2 2s-.9 2-2 2m0-4c-1.1 0-2 .9-2 2s.9 2 2 2M7 8c0-1.1-.9-2-2-2s-2 .9-2 2 .9 2 2 2m0 0c1.1 0 2 .9 2 2s-.9 2-2 2m0-4c-1.1 0-2 .9-2 2s.9 2 2 2m10 0c0-1.1-.9-2-2-2s-2 .9-2 2 .9 2 2 2m0 0c1.1 0 2 .9 2 2s-.9 2-2 2m0-4c-1.1 0-2 .9-2 2s.9 2 2 2" />
    </svg>
  );
}
...
export function PillIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 3h6m-5 0v6.5L5 16.5a2 2 0 001.7 3h10.6a2 2 0 001.7-3L14 9.5V3m-4 0h4" />
    </svg>
  );
}
...
export function MicroscopeIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6.5 12.5l5-5M16 16l-3-3M10 2h4m-2 0v4m5 5l-3-3" />
    </svg>
  );
}
...
export function NavigationIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 21l18-9L3 3v7l15 2-15 2v7z" />
    </svg>
  );
}
